...
import { RFIDRegistration } from '@/components/rfid/rfid-registration';
...
export function UserManagement() {
  ...
  const [faceRegistrationUser, setFaceRegistrationUser] = useState<User | null>(null);
  const [rfidRegistrationUser, setRfidRegistrationUser] = useState<User | null>(null);
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500">Wajah</p>
                <p className="text-xl font-bold text-gray-900">
                  {users.filter((u) => u.hasFaceData).length}
                </p>
              </div>
            </div>
          </CardContent>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <div 
                            ...
                            title={user.hasFaceData ? "Wajah terdaftar" : "Wajah belum terdaftar"}
                          >
                          ...
                          <div 
                            ...
                            title={user.hasRfidCard ? "RFID terdaftar" : "RFID belum terdaftar"}
                          >
                        ...
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48">
                              ...
                              <DropdownMenuItem
                                onClick={() => {
                                  setRfidRegistrationUser(user);
                                  setShowRFIDRegistration(true);
                                }}
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3 pt-2 border-t">
              <Label className="text-base">Fitur Login Tambahan</Label>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="faceRecognition" className="text-sm font-normal">
                    Face Recognition
                  </Label>
                  <p className="text-xs text-gray-500">
                    Aktifkan login dengan wajah
                  </p>
                </div>
                <Switch
                  id="faceRecognition"
                  ...
                  onCheckedChange={(checked) =>
                    setFormData({ ...formData, faceRecognitionEnabled: checked })
                  }
                />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="rfid" className="text-sm font-normal">
                    RFID Card
                  </Label>
                  <p className="text-xs text-gray-500">
                    Aktifkan login dengan kartu RFID
                  </p>
                </div>
                <Switch
                  id="rfid"
                  ...
                  onCheckedChange={(checked) =>
                    setFormData({ ...formData, rfidEnabled: checked })
                  }
                />
              </div>
            </div>
      ...
      {/* Face Capture Modal */}
      <AnimatePresence>
        {showFaceCapture && faceRegistrationUser && (
          <FaceCapture
            userId={faceRegistrationUser.id}
            onSuccess={() => {
      ...
      <AnimatePresence>
        {showRFIDRegistration && rfidRegistrationUser && (
          <RFIDRegistration
            userId={rfidRegistrationUser.id}
            userName={rfidRegistrationUser.namaLengkap}
            onClose={() => {
              setShowRFIDRegistration(false);
              setRfidRegistrationUser(null);
            }}
            onSuccess={() => {
              fetchUsers();
            }}
