...
export function DataKK() {
  ...
  // View mode: 'list' | 'detail' | 'formPenduduk'
  const [viewMode, setViewMode] = useState<'list' | 'detail' | 'formPenduduk'>('list');
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.nomorKK.trim()) {
      errors.nomorKK = 'Nomor KK wajib diisi';
    } else if (!/^\d{16}$/.test(formData.nomorKK)) {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Data Kartu Keluarga</h2>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{statistics.totalKK}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{statistics.totalAnggota}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{statistics.kkAktif}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-sm">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">KK Nonaktif</p>
                    <p className="text-xl font-bold text-gray-900">{statistics.kkNonaktif}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-sm">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Rata-rata Anggota</p>
                    <p className="text-xl font-bold text-gray-900">{statistics.rataRataAnggota}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                {loading ? (
                  ...
                  kkList.map((kk, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <p className="font-mono text-sm text-gray-900">{kk.nomorKK}</p>
                      </td>
                      <td className="px-4 py-3">
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Wilayah */}
              <div className="space-y-2">
                <Label htmlFor="wilayah">Wilayah (Dusun - RW - RT)</Label>
                <Select
                  value={formData.rtId}
      ...
      <Dialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Apakah Anda yakin ingin menghapus KK dengan nomor {selectedKK?.nomorKK}? 
